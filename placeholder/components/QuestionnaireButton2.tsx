...
function QuestionnaireButton2({ text, value, onClick, onMouseEnter, onMouseLeave}: {text: string, value: string, onClick: (event: React.MouseEvent<HTMLButtonElement>) => void, onMouseEnter?: () => void, onMouseLeave?: () => void }) {
